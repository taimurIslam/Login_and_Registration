...
class Registration_Form(forms.ModelForm):
    ...
    user_title = forms.ModelChoiceField(label= 'User Title', empty_label='Select User Role', queryset=Role.objects.all(),
                                        widget=forms.Select(attrs={'class': 'span8'}), required=True)
    ...
    class Meta:
        ...
        widgets = {
                ...
                'phone'         : forms.TextInput(attrs={'type': 'text','required' : 'required','placeholder': "Phone Number",'pattern': '^[\+][8][8]\d{11}','title': 'Start with +88', "class":'span8'}),
                'email'         : forms.TextInput(attrs={'type': 'text','required' : 'required', 'placeholder': "Enter Your Email ",'title': 'Enter Your Mail Here',"class": 'span8'}),
                ...
                'address'       : forms.TextInput(attrs={'type': 'text','required' : 'required', 'placeholder': "User Address","class": 'span8'})
